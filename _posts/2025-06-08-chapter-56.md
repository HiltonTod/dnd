...
Two round, rusty metal pipes run across the ceiling, from the east side to the west, each about the size
of a cantaloupe. Hanging immediately below them is a slightly smaller pipe in a circular shape
above the pool, with water dripping down into it from several small spickets. The circular area
