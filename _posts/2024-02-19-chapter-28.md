...
<ul>
  ...
  <li>They realized that they were viewing the holy symbol upside down. Turned 180 degrees,
    ...
    <a href="https://forgottenrealms.fandom.com/wiki/Talos>Talos</a>?)<br>
    <img src="/dnd/assets/images/ch28-holy-symbol-Braq.png" alt="Holy symbol discovered in warehouse">
    </li>
    
    DELETE THIS
    ![Holy symbol discovered in warehouse](/dnd/assets/images/ch28-holy-symbol-Braq.png){: .align-center }</li>
</ul>
